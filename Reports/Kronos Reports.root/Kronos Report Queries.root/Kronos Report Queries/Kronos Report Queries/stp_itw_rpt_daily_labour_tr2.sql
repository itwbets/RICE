...
IF OBJECT_ID ('[dbo].[stp_itw_rpt_daily_labour_tr2]') IS NOT NULL
DROP PROCEDURE [dbo].[stp_itw_rpt_daily_labour_tr2]; 
...
/* =============================================
	...
	Example:	 exec dbo.stp_itw_rpt_daily_labour_tr '1', '10018', '1/1/2009', '1/31/2009', '1'
	Revisions:	 PC		1/26/2010	1.0 Created
   =============================================*/

CREATE procedure [dbo].[stp_itw_rpt_daily_labour_tr2]
...
GRANT EXECUTE ON [dbo].[stp_itw_rpt_daily_labour_tr2] TO KronosReports
GO